...
CREATE TABLE "AppSettings" (
    ...
    "brandTagline" TEXT NOT NULL DEFAULT '',
    "facebookUrl" TEXT NOT NULL DEFAULT '',
    "youtubeUrl" TEXT NOT NULL DEFAULT '',
    "tiktokUrl" TEXT NOT NULL DEFAULT '',
    "themePreset" TEXT NOT NULL DEFAULT 'jade',
    "themeMode" TEXT NOT NULL DEFAULT 'LIGHT',
    "themeAllowUserToggle" BOOLEAN NOT NULL DEFAULT false,
    "themeRadius" TEXT NOT NULL DEFAULT '0.3rem',
    "themeDensity" TEXT NOT NULL DEFAULT 'DEFAULT',
    "fontHeading" TEXT NOT NULL DEFAULT 'playfair',
    "fontBody" TEXT NOT NULL DEFAULT 'manrope',
    "themeLight" JSONB NOT NULL DEFAULT '{}',
    "themeDark" JSONB NOT NULL DEFAULT '{}',
    "themePublishedAt" TIMESTAMP(3),
